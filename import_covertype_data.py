...
def get_data(name_of_file):
    ...
    column_names = ["Elevation", "Aspect", "Slope", "Horizontal_Distance_To_Hydrology",
                    ...
                    "Rawah Wilderness Area", "Neota Wilderness Area", "Comanche Peak Wilderness Area",
                    "Cache la Poudre Wilderness Area", "Soil_Type1", "Soil_Type2", "Soil_Type3", "Soil_Type4", "Soil_Type5",
